...
<div class="space-y-6 bg-white px-4 py-5 sm:p-6">
    ...
    <div class="form-group mt-3">
        ...
        <div class="flex justify-end">
            {!! Form::submit('Crear receta', ['class' => 'text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800 m-3 ']) !!}
